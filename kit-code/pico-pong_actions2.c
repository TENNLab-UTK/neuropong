...
// New bounds based on using Pico 3.3V rail - had to swap output ports, therefore NEW_MIN = (0xFF - POT_MIN)
...
uint8_t paddle_pos = (POT_MIN + POT_MAX) / 2; // Global variable for tracking paddle position between loop_use_actions() executions
